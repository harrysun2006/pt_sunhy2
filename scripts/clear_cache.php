...
/**
 * 清理缓存
 * 目前只清理apc中的语言包缓存、memcached中的勋章、宝物缓存
 * 
 * @package scripts
...
//	清理语言包
Better_Cache::local()->set('languagezhcn', null);
Better_Cache::local()->set('languageen', null);
Better_Cache::local()->set('upgrade_config', null);

//	清理勋章
$r = Better_Cache::remote()->remove('kai_badges');
var_dump($r);

//	POI 图标
$r = Better_Cache::remote()->remove('kai_poi_categories');
var_dump($r);
