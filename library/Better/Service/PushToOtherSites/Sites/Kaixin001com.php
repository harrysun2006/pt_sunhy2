 ...
 *
 */
class Better_Service_PushToOtherSites_Sites_Kaixin001com extends Better_Service_PushToOtherSites_Common
{
	public $_session_key = '';
	public $tid = '';
	...
	public function _getSessionKey($isBind=0)
	{
		...
		if ($json->result) {
			...
			$_user_info = $this->_getInfo($this->_session_key, $this->tid);
			$this->userinfo_json = $_user_info[0];
			$this->userinfo_json->profile_image_url = $_user_info[0]->logo50;
		}
...
$log_array[] = "url:$url";
	...
	/**
	 * http://pic1.kaixin001.com.cn/logo/14/50/50_6145057_1.jpg
		http://pic1.kaixin001.com.cn/logo/14/50/120_6145057_1.jpg
	 */
	public function getAvatar()
	{
		$url = '';
		$url = $this->userinfo_json->profile_image_url;
		$url = str_replace('/50_', '/120_', $url);
