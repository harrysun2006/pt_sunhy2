...
class Better_Service_LoginFromThird_Common extends Better_Service_LoginFromThird_Base
{
	/**
	 * 验证用户帐号的url
	 *
	...
	public function fakeLogin()
	{
		...
		try{
			$r = Better_Service_PushToOtherSites_Common::checkHttpCode($status, $html, 1);
		} catch(Exception $b) {
