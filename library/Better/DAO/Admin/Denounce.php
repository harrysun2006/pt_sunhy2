 ...
 *
 */
class Better_DAO_Admin_Denounce extends Better_DAO_Admin_Base{
	...
	public function changeStatus($id, $status)
	{
		...
		if($result){
			Better_Admin_Administrators::getInstance(Better_Registry::get('sess')->admin_uid)->addLog('更改举报状态为：<br>'.$status, 'change_status');
		}
