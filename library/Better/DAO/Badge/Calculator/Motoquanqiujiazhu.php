 ...
 *
 */
class Better_DAO_Badge_Calculator_Motoquanqiujiazhu extends Better_DAO_Badge_Calculator_Base
{
	...
	public static function touch(array $params)
	{
		...
		if($poiInfo['category_id']==8){
			...
			if($result){		
				...
				$condition = "CC::had_text(array('/moto/')) && CC::had_syncs(1) && CC::blog_type(array('checkin','normal'))";		
