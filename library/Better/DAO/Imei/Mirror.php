...
class Better_DAO_Imei_Mirror extends Better_DAO_Base
{
    ...
    */
    ...
    {
    	$this->tbl = BETTER_DB_TBL_PREFIX.'imei_mirror';
    	$this->priKey = 'imei';
	...
	{		
		...
		if (isset($params['uid']) && isset($params['partner'])) {
			...
			$toInsert['reg_partner'] = $params['reg_partner'];
		...
		$row = Better_DAO_Imei_Mirror::getInstance()->get($params['imei']);
