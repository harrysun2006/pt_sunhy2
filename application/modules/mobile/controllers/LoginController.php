...
class Mobile_LoginController extends Better_Mobile_Front {
	...
	public function indexAction() {
		...
		if( isset($post['email']) || isset($post['password']) ){	
			...
			$validation = array ('email' => array (array ('StringLength', 4, 50 ) ), 'password' => array (array ('StringLength', 1, 50 ) ) );
	...
	public function logoutAction(){
		...
		$this->_helper->getHelper('Redirector')->gotoUrl('/mobile?force_redirect=1');
		exit(0);
	}
}
