...
class Mobile_NotificationController extends Better_Mobile_Front  {
	...
	//	zend_debug::dump($notifications);
		...
		if( count($this->view->notifications) >= self::$maxActivities )
			$this->view->urlNext = "<a href=\"/mobile/notification/index?page=".($page+1)."\">".$this->lang->mobile->pager->next."</a>";
		if( $page > 1 )
			$this->view->urlPrev = "<a href=/mobile/notification/index?page=".($page-1)."\">".$this->lang->mobile->pager->pre."</a>";
	}
	...
	public function deleteAction(){
		...
		$this->_redirect('/mobile/notification/?page='.$page);
	}
	...
	public function sendoutAction(){
		...
		$this->_redirect('/mobile/user?uid='.$params['receiver']);
	}
	...
	public function clearAction(){
		...
		$this->_redirect('/mobile/notification');
	}
