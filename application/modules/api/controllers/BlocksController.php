 ...
 *
 */
class Api_BlocksController extends Better_Controller_Api
{
	...
	public function createAction()
	{
		...
		if ($id && $id!=$this->uid) {
			...
			if (in_array($id, $this->user->blocks)) {
				$this->error('error.blocks.already_blocked');
			} else {
